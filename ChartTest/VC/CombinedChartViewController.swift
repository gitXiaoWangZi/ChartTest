...
class CombinedChartViewController: UIViewController, IAxisValueFormatter {
...
extension CombinedChartViewController: ChartViewDelegate {
    ...
    func setupUI() {
        chartView = CombinedChartView(frame: CGRect(x: 0, y: 100, width: kScreenWidth, height: 400))
